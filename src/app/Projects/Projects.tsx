...
const Projects: React.FC<ProjectsProps> = ({ animate }) => {
  ...
  const project1 = projectCard({
    ...
    description: 'I developed and maintained the CRSTDriver mobile application using React Native and Expo, streamlining delivery and pickup management for CRST truck drivers. The app enables drivers to submit pickup confirmations, handle exceptions, and track document progress efficiently. It supports multiple user accounts with administrative oversight, ensuring seamless operations. By integrating real-time updates, the app enhances communication between drivers and dispatch teams. My contributions significantly enhanced workflow efficiency, reduced manual paperwork, and improved overall fleet management, leading to a more structured and productive logistics process.',
