...
const Experience: React.FC<ExperienceProps> = ({ animate }) => {
  ...
  const experience1 = experienceCard({
    ...
    techStack: ['React Native', 'Firebase', 'Web Socket', 'Javascript', 'Next.js', 'Redux', 'Node.js', 'Express.js', 'MySql', 'MongoDB', 'Git', 'Google Play Store', 'App Store', 'Razor pay',]
  })
  const experience2 = experienceCard({
    ...
    techStack: ['Javascript', 'React Native', 'Expo', 'React.js', 'Tailwind CSS', 'Redux', 'Node.js', 'Express.js', 'MySql', 'MongoDB']
  })
